    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">Забавно
                        <small>страница за която само програмисти могат да разберат</small>
                    </h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    <a href="#">
                        <img class="img-responsive" src="assets/images/code-30.gif" alt="">
                    </a>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    <a href="#">
                        <img class="img-responsive" src="assets/images/code-34.gif" alt="">
                    </a>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    <a href="#">
                        <img class="img-responsive" src="assets/images/code-12.gif" alt="">
                    </a>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    <a href="#">
                        <img class="img-responsive" src="assets/images/code-14.gif" alt="">
                    </a>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    <a href="#">
                        <img class="img-responsive" src="assets/images/code-13.gif" alt="">
                    </a>
                </div>
